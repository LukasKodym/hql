...
public class FromApp { // wczytuje bazę danych
    ...
    public static void main(String[] args) {
        ...
        String from3 = "from pl.lukas.hql.pl.lukas.hibernateAssociations.entity.Employee"; // w przypadku gdy encje nazywają sie tak samo podajemy pełną ścieżkę do pakietu
